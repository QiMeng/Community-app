...
-(UITextField *)textField
{
    if (!_textField) {
        ...
        _textField.placeholder = @"输入回复";
        [_textField viewLineColor:RGBA(227, 227, 227, 1) borderWidth:1 cornerRadius:0];
...
//        [_sendBtn viewLineColor:RGBA(227, 227, 227, 1) borderWidth:1 cornerRadius:0];
        [_sendBtn setBackgroundColor:RGBA(97, 191, 253, 1)];
        [_sendBtn setFrame:CGRectMake(270, 10, 40, 30)];
